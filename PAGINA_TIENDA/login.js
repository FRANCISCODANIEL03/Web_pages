...
Total: $${(total + IVA).toFixed(2)}`;
    ...
    `;
        ...
        if (parseInt(option.dataset.stock) - quantity <= 0) {
            increaseButton.disabled = true;
        }
        ...
        updateTotals();
        console.log(localStorage.getItem("productosConStock"));
    ...
    if (productosGuardados) {
        ...
        // ⚠️ Ya tienes el carrito cargado, ahora sí puedes descontar correctamente
    ...
    // Continuar con la lógica de mostrar productos
